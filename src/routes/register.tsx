    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)]">
      <div className="island-shell w-full max-w-sm rounded-2xl p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 text-xl font-bold text-[var(--sea-ink)]">Create your account</h1>
          <p className="mt-1 text-sm text-[var(--sea-ink-soft)]">PackView — 3D Packaging Viewer</p>
        </div>

        <div className="flex flex-col gap-3">
          <button onClick={handleGoogle} className="flex items-center justify-center gap-2 rounded-xl border border-[var(--line)] bg-[var(--chip-bg)] px-4 py-2.5 text-sm font-medium text-[var(--sea-ink)] transition hover:border-[#56c6be]">
          ...
          <button onClick={handleGitHub} className="flex items-center justify-center gap-2 rounded-xl border border-[var(--line)] bg-[var(--chip-bg)] px-4 py-2.5 text-sm font-medium text-[var(--sea-ink)] transition hover:border-[#56c6be]">
